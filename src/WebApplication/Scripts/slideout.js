...
//--- Configuração, aqui eu posso mexer
var menu = document.getElementById('menu-admin');
if (window.location.href.toLowerCase() === "http://localhost:31557/portal-do-aluno" ||
    window.location.href.toLowerCase() === "http://www.ecoaprender.com.br/portal-do-aluno" ||
    window.location.href.toLowerCase() === "https://localhost:31557/portal-do-aluno" ||
    window.location.href.toLowerCase() === "https://www.ecoaprender.com.br/portal-do-aluno") {
    menu = document.getElementById('menu-site');
}
